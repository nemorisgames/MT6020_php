...
$query=mysql_query("INSERT INTO InformationModuleDetail (fk_realizationModule, fk_questionID, fk_informationModuleAnswers) VALUES (3,".$_POST['preguntaID'].",".$_POST['respuestaUsuarioID'].")") or die("-2");
echo " ".$query;
