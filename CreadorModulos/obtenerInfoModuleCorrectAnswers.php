...
$query=mysql_query("SELECT * FROM InformationModuleAnswers WHERE fk_informationModuleQuestions = ".$_POST['preguntaID']." AND Correct = 'True' ORDER BY RAND() LIMIT 1") or die("-2");
$salida = "";
